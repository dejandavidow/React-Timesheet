...
export const ClientList = (props: ClientListProps) => {
  ...
  useEffect(() => {
    getClients(props.searchTerm, props.letter, pageNumber, pageSize).then(
      (data) => {
    ...
    countClients(props.searchTerm, props.letter).then((data) =>
  ...
  const updateClientHandler = () => {
    UpdateClient(
      { id, clientName, adress, city, postalCode, country },
      id
    ).then((e) => {
      ...
      <div className="container">
        ...
        >
          ...
          >
            ...
            >
              <Input
                onChange={(value) => setclientName(value.target.value)}
                value={clientName}
              />
            </Form.Item>
            ...
            <Form.Item label="Country">
              <Select
                ...
                value={country}
              >
                <Option key="1" value="Serbia">
                  Serbia
                </Option>
                <Option key="2" value="Macedonia">
                  Macedonia
                </Option>
                <Option key="3" value="Bulgaria">
                  Bulgaria
                </Option>
                <Option key="4" value="Greece">
                  Greece
                </Option>
                <Option key="5" value="Montenegro">
                  Montenegro
                </Option>
              </Select>
            </Form.Item>
