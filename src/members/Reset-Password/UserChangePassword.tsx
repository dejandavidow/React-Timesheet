...
const UserChangePassword = () => {
    ...
    {
        userChangePassword({id,oldPassword,newPassword,confirmPassword})
        .then(x =>
            {
                if(x)
                {
    ...
    <div className='container'>
        ...
        <Form
                ...
                <Form.Item
                    ...
                    //rules={[{required:true}]}
                >
                    <Input.Password style={{width:300}} value={oldPassword} onChange={(e) => setOldPassword(e.target.value)} /><br/>
                </Form.Item>
                <Form.Item
                    label="New Password"
                    name="newpassword"
                    //rules={[{required:true}]}
                >
                    <Input.Password style={{width:300}} value={newPassword} onChange={(e) => setNewPassword(e.target.value)}/>
                </Form.Item>
                <Form.Item
                    ...
                    //rules={[{required:true}]}
                    >
                    <Input.Password style={{width:300}} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}/><br/>
